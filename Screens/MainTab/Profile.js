          ...
          <View style={[styles.info, {height: 160, padding: 5}]}>
            <ScrollView>
              <VStack ml="2" mt="1" p="1" space={1}>
                <View
                  style={{display: userProfile.about == '' ? 'none' : 'flex'}}>
                  <Text style={styles.dbodyHead}>About</Text>
                  <Text style={styles.dbodyText}>{userProfile.about}</Text>
                </View>
      ...
      <View style={styles.infoContainer}>
        <View style={styles.info}>
          <View>
            <TouchableOpacity
              activeOpacity={0.7}
              onPress={() => navigation.navigate('cures')}>
              <View style={styles.infoDetails}>
                <View style={styles.icon}>
                  <Icon name="medical-outline" size={22} color="aliceblue" />
                </View>

                <Text style={styles.infoText}>My Cures</Text>
            ...
            <TouchableOpacity
              ...
              <View style={styles.infoDetails}>
                <View style={styles.icon}>
                  <Icon name="heart" size={22} color="aliceblue" />
                </View>

                <Text style={styles.infoText}>Favourites</Text>
                <View style={{position: 'absolute', right: 20}}>
                  <AntDesign name="right" size={15} color={'#00415e'} />
                </View>
              </View>
            ...
            <TouchableOpacity
              ...
              <View style={styles.infoDetails}>
                <View style={styles.icon}>
                  <Icon name="chatbubble" size={21} color="aliceblue" />
                </View>

                <Text style={styles.infoText}>Inbox</Text>
                <View style={{position: 'absolute', right: 20}}>
                  <AntDesign name="right" size={15} color={'#00415e'} />
                </View>
              </View>
