...
//         options={{headerTitle: 'Create Article',  headerLeft:()=>(<IonIcon name="-back-outline" style={{marginLeft:10,  marginTop:Platform.OS === 'android'?0:45}} color={'#00415e'} size={28} onPress={()=>{Navigation.dispatch(StackActions.pop(1))}}/>)}}
//       />
//       <Home.Screen
//         name="Result"
//         component={Result}
